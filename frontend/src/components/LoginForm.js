    ...
    return (
        <div style={{ maxWidth: '400px', margin: 'auto', padding: '28px 24px', border: '1px solid #e2e8f0', borderRadius: '12px', backgroundColor: '#ffffff', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
            ...
            <div style={{
                ...
                <div style={{ fontWeight: 600, marginBottom: '6px', color: '#334155', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <span>Cloud / Demo Accounts:</span>
                </div>
                <div style={{ display: 'flex', gap: '8px' }}>
                    ...
                    <button
                        type="button"
                        onClick={() => { setUsername('developer'); setPassword('developer123'); }}
                        style={{
                            flex: 1,
                            padding: '6px 8px',
                            borderRadius: '6px',
